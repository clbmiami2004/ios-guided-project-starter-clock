    ...
    override func draw(_ rect: CGRect) {
        ...
        if let context = UIGraphicsGetCurrentContext() {
            ...
            context.addEllipse(in:
                CGRect(x: rect.origin.x + borderWidth / 2.0,
            ...
            let timeComponents = calendar.dateComponents([.hour, .minute, .day, .weekday], from: Date())
            ...
            let dayString = "\(weekdayString)" as NSString
            let dayOriginX = clockCenter.x + rect.width / 5
            let dayOriginY = clockCenter.y
            dayString.draw(in: CGRect(x: dayOriginX,
                       y: dayOriginY,
                       width: 200,
                       height: digitFont.lineHeight),
            withAttributes: [NSAttributedString.Key.foregroundColor: digitColor,
            ...
            let centerCircleRect =
                CGRect(x: clockCenter.x - largeDotRadius,
            ...
            let secondsCircleRect =
                CGRect(x: clockCenter.x - smallDotRadius,
